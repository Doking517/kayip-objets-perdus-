			...
			<div class="content-block">
				...
				<div class="section-full bg-white content-inner">
					<div class="container">
						<div class="section-head text-black text-center">
							...
							<h2 class="box-title">VOUS AVEZ PERDU VOS CLÉS /OBJETS ?</h2>
							<div class="dlab-separator bg-primary"></div>
							<p>Toutes les photos de clés que nous recevons sont systématiquement enregistrées dans la galerie photo des objets. Vous pouvez également vous rendre a la page des <a href="./galerie.php" style="color: #4611A7;">objets perdus</a> pour les identifier.
								N’oubliez pas de faire une déclaration de perte et donnez le plus d'informations possible sur l'objet perdu.
							</p>
						</div>
						<div class="section-head text-black text-center">
							...
							<div class="dlab-separator bg-primary"></div>
							<p>Lorsque la photo d'un objet est déposée sur notre plateforme, nous faisons notre possible pour trouver son propriétaire et prendre contact avec lui.
								Une recherche automatique est faite entre objets perdus et trouvés.</p>
						</div>
						<div class="section-head text-black text-center">
							<h1 class="box-title">VOUS AVEZ TROUVÉ UN OBJET</h1>
							<div class="dlab-separator bg-primary"></div>
							<p>Vous devez vous enregistrer a travers un des deux formulaires; <a href="./objets_trouvesNA.php" style="color: blue;">cliquez ici</a>
								En laissant vos coordonnées. Vous devennez inventeur de l’objet.</p>
						</div>
					</div>
				</div>
				...
				<div class="section-full bg-gray content-inner about-us">
					<div class="container-fluid">
						<div class="section-head text-black text-center">
							<h2 class="box-title">VOUS VENEZ PERSONNELLEMENT RÉCUPÉRER VOTRE OBJET</h2>
							<div class="dlab-separator bg-primary"></div>
							<p>Munissez-vous d'une pièce d'identité <br>
						...
						<div class="row">
							<div class="col-lg-4 col-md-4">
								<div class="icon-bx-wraper sr-box center box1 m-b30">
									...
									<div class="icon-content">
										...
										<p>A travers notre plateforme, vous pouvez repertorier tout type d'objets trouvés...<br><br></p>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-md-4">
							...
							<div class="col-lg-4 col-md-4">
								<div class="icon-bx-wraper sr-box center box1 m-b30">
									...
									<div class="icon-content">
										<h3 class="dlab-tilte">Recupérez vos objets perdus</h3>
										<p>Après avoir prouvé que l'objèt en question est le votre, vous pourez entrer en possession à travèrs le dépositaire...</p>
									</div>
								</div>
							</div>
						</div>
