...
<!-- Mirrored from bizmap.dexignzone.com/xhtml/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Jun 2022 11:28:03 GMT -->
<head>
	<meta charset="utf-8">
		...
		<div class="col-lg-12 mb-4 mb-md-0"><br>
                        <div class="clearfix contact-form m-b30">
							<div class="section-head mt-5 text-black">
								<h2 class="box-title">Bienvenue Utilsateurs Anonymes.</h2>
							...
							<form method="post" class="dzForm" action="https://bizmap.dexignzone.com/xhtml/script/contact.php">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="input-group">
                                                <input name="nom" type="text" required class="form-control" placeholder="Nom de l'objet">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="input-group"> 
											    <input name="ville" type="text" class="form-control" required  placeholder="Ville de l'objet" >
                                            </div>
                                        </div>
                                    </div>
									<div class="col-md-6">
                                        <div class="form-group">
                                            <div class="input-group">
                                                <input name="quartier" type="text" required class="form-control" placeholder="Quartier de l'objet">
                                            </div>
                                        </div>
                                    </div>
									<div class="col-md-6">
									...
									<div class="col-md-6">
                                        <div class="form-group">
                                            <div class="input-group">
											<input name="contact" type="text" required class="form-control" placeholder="Votre Contact">
                                            </div>
                                        </div>
                                    </div>
									<div class="col-md-6">
...
<!-- Mirrored from bizmap.dexignzone.com/xhtml/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Jun 2022 11:28:36 GMT -->
</html>
